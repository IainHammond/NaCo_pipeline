...
postproc.postprocessing(do_adi=True, do_adi_contrast=False, do_pca_full=True, do_pca_ann=False, cropped=True,
                        do_snr_map=True, do_snr_map_opt=True, delta_rot=(0.5,3), mask_IWA=2, plot=True, verbose=True, debug=False)

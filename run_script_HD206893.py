...
preproc = calib_dataset('/home/ihammond/pd87_scratch/products/NACO_archive/6_HD206893/calibrated/','/home/ihammond/pd87_scratch/products/NACO_archive/6_HD206893/preproc/', 47, 'speckle', 'gauss', coro=True)

preproc.recenter(nproc = 1, sigfactor = 4, subi_size = 21,verbose = True, debug = False, plot = False, coro = True)
preproc.bad_frame_removal(correlation_thres = 0.95, pxl_shift_thres = 0.5, crop_size = 31, verbose = True, debug = False, plot = 'save')

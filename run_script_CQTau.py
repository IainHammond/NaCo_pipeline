...
#dictionary to pass through the pipeline saving all the dataset information
...
clas = input_dataset('/home/ihammond/pd87_scratch/products/NACO_archive/10_CQTau/raw/','/home/ihammond/pd87_scratch/products/NACO_archive/10_CQTau/classified/', dataset_dict,coro = True)
...
calib = raw_dataset('/home/ihammond/pd87_scratch/products/NACO_archive/10_CQTau/classified/','/home/ihammond/pd87_scratch/products/NACO_archive/10_CQTau/calibrated/', dataset_dict,final_sz = None)

calib.dark_subtract(bad_quadrant = [3], debug = False, plot = 'save')
# ##calib.fix_sporadic_columns(quadrant='topleft', xpixels_from_center = 7, interval = 8, verbose = True, debug = False)
...
#preproc = calib_dataset('/home/ihammond/pd87_scratch/products/NACO_archive/10_CQTau/calibrated/','/home/ihammond/pd87_scratch/products/NACO_archive/10_CQTau/preproc/', dataset_dict, recenter_method = 'speckle', recenter_model = 'gauss', coro=True)

#preproc.recenter(nproc = 1, sigfactor = 4, subi_size = 21, crop_sz = 251, verbose = True, debug = False, plot = False, coro = True)
